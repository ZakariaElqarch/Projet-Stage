        ...
        <div class="form-three widget-shadow">
            <form action="{{ route('convention.store') }}" method="POST" class="form-horizontal Convention-form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control1" name="validity" id="Validity"
                            placeholder="date de validiter" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="focusedinput" class="col-sm-3 control-label">Budget<span class="required"> *</span></label>
                    <div class="errorbudget col-sm-8 ">
                        <input type="text" name="budget" class="form-control1 budget" id="Budget"
                            placeholder=" 6.575,45 DH">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="selector1" class="col-sm-3 control-label">Division:<span class="required">
                            *</span></label>
                    <div class="col-sm-8 errorDivision"><select name="SelectDivision" id="SelectDivision"
                            class="form-control1">
                            <option disabled selected>--choisi--</option>
                ...
                <div class="form-group">
                    <label for="selector1" class="col-sm-3 control-label">Les Partenaires:<span class="required">
                            *</span></label>
                ...
                <div class="form-group">
                    <label for="selector1" class="col-sm-3 control-label">Les Communes:<span class="required">
                            *</span></label>
